...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Member.googleplus'
        db.add_column(u'organisation_member', 'googleplus',
                      self.gf('django.db.models.fields.URLField')(default='', max_length=255, blank=True),
                      keep_default=False)

        # Adding field 'Organisation.googleplus'
        db.add_column(u'organisation_organisation', 'googleplus',
                      self.gf('django.db.models.fields.URLField')(default='', max_length=255, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Member.googleplus'
        db.delete_column(u'organisation_member', 'googleplus')

        # Deleting field 'Organisation.googleplus'
        db.delete_column(u'organisation_organisation', 'googleplus')
