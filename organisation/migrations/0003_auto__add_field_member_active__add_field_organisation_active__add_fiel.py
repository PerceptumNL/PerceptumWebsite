...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'organisation_member', 'active',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'Organisation.active'
        db.add_column(u'organisation_organisation', 'active',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'ProjectCategory.active'
        db.add_column(u'organisation_projectcategory', 'active',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'Project.active'
        db.add_column(u'organisation_project', 'active',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'organisation_member', 'active')

        # Deleting field 'Organisation.active'
        db.delete_column(u'organisation_organisation', 'active')

        # Deleting field 'ProjectCategory.active'
        db.delete_column(u'organisation_projectcategory', 'active')

        # Deleting field 'Project.active'
        db.delete_column(u'organisation_project', 'active')
